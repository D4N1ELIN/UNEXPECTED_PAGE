      ...
      <header class="header">
            <div class="contenedor">
                ...
                <nav class="nav" id="nav">
                    <ul class="menu">
                        ...
                        <li class="menu__item"><a class="menu__link " href="TicketTecnico.php">Tickets</a></li>
       ...
       <div id="slides">
           <ul class="slides-container">
               <li><img src="imagenes/FondoInicio4.jpg" alt="">
                   <h1 class="tituloA">Bienvenido Tecnico <?php echo $nomUsuario;?></h1>
               </li>
               <li><img src="imagenes/FondoInicio3.jpg" alt="">
                   <h1 class="tituloA">Bienvenido Tecnico <?php echo $nomUsuario;?> </h1>
                   <h1 class="nom_usu"> </h1>
               </li>
           </ul>
