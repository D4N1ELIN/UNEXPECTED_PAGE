<?php
    ...
    $query="SELECT ticket.idTicket,ticket.Asunto_tick,ticket.Fecha_tick, ticket.Descripcion_tick, categoria.Descripcion_cate, subcategoria.Descripcion_Sub, tecnico.NombreTec,estado.tip_estado FROM ticket 
 ...
 //header
    ...
    $pdf->Cell(90,15,"Usuario: $nomUsuario $apeUsuario",1,0,'C',1);
    //
    ...
    $pdf->Cell(26,10,'Asunto',1,0,'C',1);
    $pdf->Cell(21,10,'Fecha',1,0,'C',1);
    ...
    while($row = $ejecutarQuery->fetch_assoc())
    {
        ...
        $pdf->Cell(26,14,utf8_decode($row['Asunto_tick']),1,0,'C');
        $pdf->Cell(21,14,$row['Fecha_tick'],1,0,'C');
        $pdf->Cell(30,14,utf8_decode($row['Descripcion_tick']),1,0,'C');
