...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Ticket Administrador</title>
    ...
    <body>
      ...
      <header class="header">
            <div class="contenedor">
                ...
                <nav class="nav" id="nav">
                    <ul class="menu">
                        ...
                        <li class="menu__item"><a class="menu__link " href="UsuariosAdmin.php">Usuarios</a></li>
       ...
       <form method="post">
                   ...
                   <?php
                    ...
                    while($lista_ticket= $ejecutar_sql->fetch_array(MYSQLI_BOTH)){
                        echo'<tr>
                                ...
                                <td> <a href="EditTicket.php?id='.$lista_ticket['idTicket'].'"><button type="submit"> EDITAR</button></a> </td>
                                <td> <a href="FormularioInd.php?id='.$lista_ticket['idTicket'].'"><button type="submit"> EXPORTAR</button></a> </td>
        ...
        <form action="FormularioTickAdmin_pdf.php" method="post">
